...
class NetPlotter:
    ...
    def plot(self, reaction_ids: set = set(), omit_metabolites: set = set(), highlight_nodes: set = set(), layout_func: Callable[[nx.Graph], Mapping] = None, figsize: Tuple[int, int] | None = None) -> None:
        # Get types of nodes
